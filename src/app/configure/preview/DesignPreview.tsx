...
const DesignPreview = ({configuration}: {configuration: Configuration}) => {
    ...
    return <>
        <div aria-hidden="true" className="pointer-events-none select-none absolute inset-0 overflow-hidden flex justify-center">
            <Confetti active={showConfetti} config={{elementCount: 300, spread: 90}} />
        </div>

        <LoginModal setIsOpen={setIsLoginModalOpen} isOpen={isLoginModalOpen} />

        <div className="mt-20 flex flex-col md:grid text-sm sm:grid-cols-12 sm:grid-rows-1 sm:gap-x-6 md:gap-x-8 lg:gap-x-12">
