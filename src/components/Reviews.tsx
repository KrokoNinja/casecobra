...
function Review({imgSrc, className, ...props} : ReviewProps) {
    ...
    const POSSIBLE_ANIMATIONS_DELAYS = ["0s", "0.1s", "0.2s", "0.3s", "0.4s", "0.5s"];

    const animationDelay = POSSIBLE_ANIMATIONS_DELAYS[Math.floor(Math.random() * POSSIBLE_ANIMATIONS_DELAYS.length)];
