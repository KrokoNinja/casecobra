...
const OrderReceivedEmail = ({shippingAddress, orderId, orderDate} : {shippingAddress: ShippingAddress, orderId: string, orderDate: string}) => {
    ...
    const baseUrl = process.env.NODE_ENV === 'production' ? 'https://casecobra-ten.vercel.app/' : 'http://localhost:3000'
            ...
            <Container style={container}>
                <Section style={message}>
                    ...
                    <Text style={{...global.text, marginTop: 24}}>
                        If you have any questions reguarding your oder, please feel free to contact us with your order number and we're here to help.
                    </Text>
                </Section>
                <Hr style={global.hr} />
